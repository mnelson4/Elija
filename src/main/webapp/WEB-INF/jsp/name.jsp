...
<html>
 ...
 <body>
   <h2>OAuth Test client for FamilySearch</h2>

<?php
$consumer_key = "[your-developer-key]"; # FamilySearch Developer Key
$oauth_callback = urlencode("http://localhost:[port]/oauth_sample.php"); # Set this to the URL from which you are running this script
$server = "https://sandbox.familysearch.org"; # https://api.familysearch.org if working with production system
...
if ($_GET["oauth_verifier"] == NULL) {
 ...
 $content = 'Click <a href="'.$server.$authorizeUrl.'?oauth_token='.$response['oauth_token'].'">here</a> to authenticate to FamilySearch';
}
...
if ($_GET["oauth_verifier"] != NULL) {
 ...
 print("<br />Authentication to FamilySearch successful. Your user info is:<br /><pre>");
 print_r("sessionId is: ".$sessionId."\n");
 print_r(htmlentities(http($server."/familytree/v2/user/?sessionId=".$sessionId)));
 print "</pre>";
